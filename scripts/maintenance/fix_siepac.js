...
async function showMethodologyResults(lineName) {
    ...
    function renderAsia() {
        ...
        let selF = Math.abs(averageFlowS1);
        ...
        let stamp_pay_country = { [globalData.expCountry]: demFr * stamp_tariff, [globalData.impCountry]: demTo * stamp_tariff };
        ...
        const calculateExPostASIA = (isCon, method) => {
            ...
            return { bsE: mOpE + peE, bsI: mOpI + peI, bgE: mPrE + crE - peE, bgI: mPrI + crI - peI, cdE: mDmE + peE, cdI: mDmI + peI };
        };
    ...
    function renderEuropa() {
        ...
        let nf_exp = selF; let nf_imp = selF;
        ...
        let itc_inc_e = fund * 0.5; let itc_inc_i = fund * 0.5; 
    ...
    function renderSiepac() {
        ...
        let curtrc = Rc > 0 ? MR_allocated / Rc : 0; let curtrg = Ig > 0 ? MI_allocated / Ig : 0;
            ...
            <div class="res-card">
                ...
                <div class="res-card-body" style="background:#f9fafb;">
                    <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 12px; align-items:flex-end;">
                        ...
                        <div style="flex:1; min-width: 180px"><span class="form-label">País Analizado</span><select id="sie_country" class="form-input">
                ...
                <div class="res-card" style="flex:1; border-top: 4px solid #8b5cf6;">
                    ...
                    <div class="res-card-body">
                        ...
                        <div style="margin-top: 20px; font-size: 0.85em; color: #4b5563; padding: 12px; background: #f3f4f6; border-radius: 6px;">
                            ...
                            Se incluyen en la asignación todas las variables financieras del modelo de interfaz react original.
                        </div>
                    </div>
                </div>
            </div>
...
const regex = /async function showMethodologyResults\([\s\S]*$/;
...
console.log('Appended securely with updated SIEPAC fields');
